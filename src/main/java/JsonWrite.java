...
public class JsonWrite {
    ...
    public void addProduct(Product product, String fileName) throws IOException {
    ...
    public void addProduct(List<Product> product, String fileName) throws IOException {
        for (int i = 0; i < product.size(); i++){
            addProduct(product.get(i), fileName);
        }
